...
public abstract class PlusBaseActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlusClient =
                new GoogleApiClient.Builder(this, this, this).addApi(Plus.API).addApi(LocationServices.API).build();//.setScopes(Scopes.PLUS_LOGIN,Scopes.PLUS_ME).build();
    }
     ...
     * This will call back to disconnect.
     */
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mLastLocation != null) {
            Log.d("GoogleAPI",mLastLocation.getLatitude() + ":" + mLastLocation.getLongitude());
        }
    }
